          ...
          children: [
            ...
            if (_isAdmin) ...[
              ...
              _buildDrawerItem(context, Icons.admin_panel_settings_rounded,
                  ...
                  isDark: isDark),
              _buildDrawerItem(context, Icons.dashboard_customize_rounded,
                  'Command Center', '/admin/command-center',
                  isDark: isDark),
              _buildDrawerItem(context, Icons.analytics_rounded, 'Analytics',
                  '/admin/analytics',
                  isDark: isDark),
              _buildDrawerItem(context, Icons.people_alt_rounded,
                  'User Activity', '/admin/user-activity',
                  isDark: isDark),
              _buildDrawerItem(context, Icons.assessment_rounded, 'Reports',
                  '/admin/reports',
                  isDark: isDark),
              _buildDrawerItem(context, Icons.manage_accounts_rounded,
